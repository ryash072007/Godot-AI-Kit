...
The implementation of this algorithm currently does not support alpha-beta pruning or depth-limited minimax, i.e., this algorithm is not optimised whatsoever.
